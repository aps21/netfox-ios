    ...
    class NFXListCell: UITableViewCell {
        ...
        override func layoutSubviews() {
            ...
            URLLabel.frame = CGRect(
                ...
                y: 0,
                width: frame.width - URLLabel.frame.minX - 25 - padding,
                height: 40
            )
            ...
            rightSeparator.frame = CGRect(
                x: leftSeparator.frame.maxX,
                y: frame.height - 1,
                width: frame.width - leftSeparator.frame.maxX,
                height: 1
            )
        }
