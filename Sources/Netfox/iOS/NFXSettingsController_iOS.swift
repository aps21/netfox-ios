        ...
        DataCleaner
    {
        ...
        override func viewDidLoad() {
            ...
            navigationItem.rightBarButtonItems = [
                UIBarButtonItem(
                    ...
                    style: .plain,
                    target: self,
                    action: #selector(NFXSettingsController_iOS.statisticsButtonPressed)
                ),
                UIBarButtonItem(
                    image: UIImage.NFXInfo(),
                    style: .plain,
                    target: self,
                    action: #selector(NFXSettingsController_iOS.infoButtonPressed)
                ),
            ]
        ...
        func tableView(_: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            case 0:
                ...
                nfxEnabledSwitch.addTarget(
                    self,
                    action: #selector(NFXSettingsController_iOS.nfxEnabledSwitchValueChanged(_:)),
                    for: .valueChanged
                )
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            case 1:
                ...
                filters[(indexPath as NSIndexPath).row] = !filters[(indexPath as NSIndexPath).row]
                configureCell(cell, indexPath: indexPath)
