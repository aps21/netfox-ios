...
@objc public class NFXHTTPModel: NSObject {
    ...
    @objc public func getRequestBodyFilename() -> String {
        String("nfx_request_body_") + "\(requestTime!)_\(getRandomHash() as String)"
    }
    ...
    @objc public func getResponseBodyFilename() -> String {
        String("nfx_response_body_") + "\(requestTime!)_\(getRandomHash() as String)"
    }
    ...
    @objc public func readRawData(_ fromFile: String) -> Data? {
        (try? Data(contentsOf: URL(fileURLWithPath: fromFile)))
    }
    ...
    @objc public func isSuccessful() -> Bool {
        if responseStatus != nil, responseStatus < 400 {
            return true
        } else {
            return false
        }
